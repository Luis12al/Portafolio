...
export const projects: Project[] = [
  ...
  },
  {
    id: '2',
    title: 'HomeViewBca',
    description: 'HomeViewBca es una plataforma web para la compra, venta y alquiler de propiedades inmobiliarias en el Distrito Especial de Barrancabermeja.',
    longDescription: 'HomeViewBca planea ser plataforma web para la compra, venta y alquiler de propiedades inmobiliarias en el Distrito Especial de Barrancabermeja mediante recorridos virtuales inmersivos y amueblamiento personalizado.',
    image: '/projects/api.jpg',
    technologies: ['React + Vite', 'TypeScript', 'Tailwind CSS', 'Material UI (MUI)', 'A‑Frame'],
    demoUrl: 'https://homeviewbca.onrender.com/casas',
  ...
  },
  {
    ...
    description: 'Aplicación web de portafolio profesional',
    longDescription: 'Portafolio web profesional e interactivo diseñado para presentar proyectos, habilidades y experiencia de desarrollo. La aplicación incorpora animaciones, navegación dinámica y componentes reutilizables para ofrecer una experiencia moderna y atractiva al usuario.',
    image: '/projects/blog.jpg',
    technologies: ['React + Vite', 'TypeScript', 'CSS'],
    demoUrl: 'https://portafolio-iuzc.onrender.com/',
    codeUrl: 'https://github.com/Luis12al/Portafolio.git',
    featured: false,
    category: 'Frontend',
  },
  {
